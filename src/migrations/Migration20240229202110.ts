...
export class Migration20240229202110 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table "pokemon_entity" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "name" varchar(255) not null, "classification" varchar(255) null, "height_minimum" varchar(255) not null, "height_maximum" varchar(255) not null, "flee_rate" real not null, "weight_minimum" varchar(255) not null, "weight_maximum" varchar(255) not null, "evolution_requirements" jsonb null, "evolutions" jsonb null, "previous_evolutions" jsonb null, "max_cp" int not null, "max_hp" int not null, "common_capture_area" varchar(255) null, "class" text check ("class" in (\'legendary\', \'mythic\')) null);');

    this.addSql('create table "type_entity" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "name" varchar(255) not null);');
    ...
    this.addSql('create table "attack_entity" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "name" varchar(255) not null, "type_id" int not null, "damage" int not null);');
    ...
    this.addSql('create table "user_entity" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "auth_token" varchar(255) not null);');

    this.addSql('create table "user_entity_favorite_pokemons" ("user_entity_id" int not null, "pokemon_entity_id" int not null, constraint "user_entity_favorite_pokemons_pkey" primary key ("user_entity_id", "pokemon_entity_id"));');
    ...
    this.addSql('alter table "user_entity_favorite_pokemons" add constraint "user_entity_favorite_pokemons_user_entity_id_foreign" foreign key ("user_entity_id") references "user_entity" ("id") on update cascade on delete cascade;');
    this.addSql('alter table "user_entity_favorite_pokemons" add constraint "user_entity_favorite_pokemons_pokemon_entity_id_foreign" foreign key ("pokemon_entity_id") references "pokemon_entity" ("id") on update cascade on delete cascade;');
  }
  ...
  async down(): Promise<void> {
    ...
    this.addSql('alter table "user_entity_favorite_pokemons" drop constraint "user_entity_favorite_pokemons_pokemon_entity_id_foreign";');
    ...
    this.addSql('alter table "user_entity_favorite_pokemons" drop constraint "user_entity_favorite_pokemons_user_entity_id_foreign";');
    ...
    this.addSql('drop table if exists "user_entity_favorite_pokemons" cascade;');
  }
